...
<div>
    ...
    <div class="fixed bottom-10 left-1/2 transform -translate-x-1/2">
        <a href="https://api.whatsapp.com/send/?phone=6281370177719&text=Selama%20Siang,%20saya%20ingin%20menanyakan%20informasi%20mengenai%20wisata%20edukasi%20lebih%20lanjut.%20Terima%20kasih.&type=phone_number&app_absent=0"
           target="_blank">
            <button class="bg-green1 hover:bg-green2 text-white font-bold py-4 px-6 rounded-full shadow-lg"> Hubungi
                Admin
            </button>
        </a>
    </div>
...
<section class="blog-post text-gray-600 body-font bg-slate">
            ...
            <div class="flex flex-wrap -m-4">
                ...
                @foreach ($posts as $post)
                    <div class="p-4 md:w-1/3">
                        <div class="h-full border-2 border-softblue border-opacity-60 rounded-lg overflow-hidden">
